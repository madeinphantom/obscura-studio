                ...
                {[...Array(10)].map((_, i) => (
                  <div
                    className={cn(
                      ...
                      "opacity-0",
                      "shadow-[0_0_50px_rgba(183,209,234,0.5)]",
              ...
              <div className="group/icon relative">
                <div
                  className={cn(
                    ...
                    "bg-gradient-to-br from-[#b7d1ea]/20 via-[#b7d1ea]/10 to-transparent"
                  )}
                />
                <Repeat2 className="group-hover/icon:-rotate-12 relative z-10 h-4 w-4 text-[#b7d1ea] transition-transform duration-300 group-hover/icon:scale-110" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="space-y-2">
              {features.map((feature, index) => (
                ...
                >
                  <ArrowRight className="h-3 w-3 text-[#b7d1ea]" />
                  <span>{feature}</span>
                </div>
              ))}
            </div>
          ...
          <div className="mt-6 border-zinc-200 border-t pt-6 dark:border-zinc-800">
            <div
              className={cn(
                ...
                "hover:from-0% hover:from-[#b7d1ea]/10 hover:via-100% hover:via-[#b7d1ea]/5 hover:to-100% hover:to-transparent",
                "dark:hover:from-0% dark:hover:from-[#b7d1ea]/20 dark:hover:via-100% dark:hover:via-[#b7d1ea]/10 dark:hover:to-100% dark:hover:to-transparent",
                "hover:scale-[1.02] hover:cursor-pointer"
              )}
            >
              <span className="font-medium text-sm text-zinc-900 transition-colors duration-300 group-hover/start:text-[#b7d1ea] dark:text-white dark:group-hover/start:text-[#b7d1ea]">
                Start today
              </span>
              <div className="group/icon relative">
                <div
                ...
                />
                <ArrowRight className="relative z-10 h-4 w-4 text-[#b7d1ea] transition-all duration-300 group-hover/start:translate-x-0.5 group-hover/start:scale-110" />
              </div>
            </div>
          </div>
        </div>
      ...
      <style jsx>{`
                @keyframes scale {
                    0% {
                        transform: scale(2);
                        opacity: 0;
                        box-shadow: 0px 0px 50px rgba(183, 209, 234, 0.5);
                    }
                    50% {
                        transform: translate(0px, -5px) scale(1);
                        opacity: 1;
                        box-shadow: 0px 8px 20px rgba(183, 209, 234, 0.5);
                    }
                    100% {
                        transform: translate(0px, 5px) scale(0.1);
                        opacity: 0;
                        box-shadow: 0px 10px 20px rgba(183, 209, 234, 0);
                    }
                }
            `}</style>
    </div>
